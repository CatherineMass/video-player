...
const SearchBar = ({ handleFilter, filteredList, handleSearch }) => {
    return (react_1.default.createElement("div", { className: "search-bar" },
        react_1.default.createElement("div", { className: "search-bar__input" },
            react_1.default.createElement("input", { type: "text", className: "search-bar__input-field", placeholder: 'Search a video', "aria-label": "Search a video", onChange: handleFilter }),
