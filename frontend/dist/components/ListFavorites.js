...
const ListFavorites = ({ clickHeart, favoritesVideos, favVideos, handleSidebarClick, }) => {
    console.log(favVideos);
    return (react_1.default.createElement("div", { className: "list-favorites" }, favVideos.map((video) => {
        var _a, _b, _c;
