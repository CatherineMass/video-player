...
const MainContainer = ({ defaultVideo, handleFilter, filteredList, handleSearch, placeholder, currentVideo, nextClick, prevClick, sendVideoToSidebar, }) => {
    return (react_1.default.createElement("div", { className: "main-container" },
        ...
        react_1.default.createElement(SearchBar_1.default, { handleFilter: handleFilter, filteredList: filteredList, handleSearch: handleSearch, placeholder: placeholder }),
        react_1.default.createElement("div", { className: "video-and-btn-container" },
            react_1.default.createElement(Video_1.default, { currentVideo: currentVideo, defaultVideo: defaultVideo, sendVideoToSidebar: sendVideoToSidebar }),
